...
- **Linguaggio di Programmazione:** SvelteKit
- **Database:** In memory
- **Storage:** In memory (generato runtime e poi dimenticato)
- **Grafica:** TailwindCSS
...
3.  **Gestione Giorni Speciali:**
    ...
    - -> Selettora con tipologia del giorno: Lavoro, Ferie, Malattia, Permesso retribuito, Chiusura aziendale, Festività, Sabato, Domenica
...
5.  **Esportazione PDF Orari:**
    ...
    - Il formato del PDF dovrà rispettare il fac-simile fornito ("tabella_orari_25-06.csv").
...
1.  **Integrazione API Trenitalia (da effettuare backend per evitare le politiche CORS):**
...
4.  **Esportazione PDF Rimborsi Spese:**
    ...
    - Il PDF includerà anche tutti i documenti allegati per le varie spese. Le immagini allegate dovranno essere incluse nel PDF, adattandosi alla dimensione di una pagina.
    - Il formato del PDF dovrà rispettare il fac-simile fornito ("rimborso_25-06.csv").
